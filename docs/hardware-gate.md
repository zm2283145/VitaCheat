...
host/Vita cross-build evidence plus a device-proven create-bound authorization
and controller-replacement result, but no foreign-read pass. That layer does
not retroactively widen this ABI or its same-process hardware claim.
